...
//database creds
define('db_name', 'sharpspring_prophet_api');
define('db_user', 'SSPr4Pi!dm1nIs');
define('db_pass', 'R2LMrqzz41iEmR32');
//define('db_host', 'localhost'); // on remote server
define('db_host', '216.70.109.81');
...
define('sharpspring_account', '329023B8902CDD5B9FD8D4223C53D1AC');
